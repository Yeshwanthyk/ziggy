import { parseLookResponse, type LookResponse } from "../../outline.mts";
import { toBoolean, toFiniteNumber, toOptionalString } from "../coerce.mts";
import type { ComputerUsePlatformBackend, FramePoints, HelperActResult, PlatformActRequest, PlatformApp, PlatformFocusWindowResult, PlatformFrontmostResult, PlatformObserveRequest, PlatformReadTextRequest, PlatformReadTextResponse, PlatformReadyState, PlatformRoot, PlatformRootKind, PlatformRootQuery, PlatformTarget, PlatformWaitForRequest, PlatformWaitForResponse } from "../types.mts";
import { WINDOWS_HELPER_PROTOCOL_VERSION, windowsHelper } from "./helper.mts";
import { assertPlatformArchitecture } from "../architecture.mts";
