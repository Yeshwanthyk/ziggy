...
import { ensurePermissions, type PermissionKind, type PermissionStatus } from "../../permissions.mts";
import { toBoolean, toFiniteNumber, toOptionalString } from "../coerce.mts";
import type { PlatformReadyState } from "../types.mts";
import { HELPER_APP_PATH, macosHelper } from "./helper.mts";
