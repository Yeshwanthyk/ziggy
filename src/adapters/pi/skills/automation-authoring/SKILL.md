...
5. A schedule is unattended only when `automation_list` reports the Profile scheduler online. If it is offline, say that the definition exists but the background scheduler isn't running.
