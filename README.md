...
Current version is **0.2.12**. Notable changes live in [CHANGELOG.md](CHANGELOG.md).
...
`ziggy update` uses the same GitHub release assets. Linux and Intel Mac builds are not in 0.2.12.
