import { containsPromiseType, nodeName } from "../utils.mjs";

const message =
  "Do not expose Promise-shaped client surfaces. Wrap third-party SDK promises at the adapter boundary and expose Effect methods. Skill: wrdn-effect-client-wrapper.";
