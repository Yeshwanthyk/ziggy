import { getCallName, isIdentifier, typeReferenceName } from "../utils.mjs";

const message =
  "This object type duplicates a nearby Effect Schema. Export an inferred type from the schema instead. Skill: effect-schema-inferred-types.";
