import { isIdentifier, nodeName } from "../utils.mjs";

const message =
  "Do not use instanceof for tagged errors. Use Effect.catchTag, Effect.catchTags, or Predicate.isTagged. Skill: wrdn-effect-typed-errors.";
