...
const message =
  "Do not erase Effect failures with die/orDie/ignore escape hatches. Keep typed errors in the error channel, or catch them explicitly and report, aggregate, or recover. Skill: wrdn-effect-typed-errors.";
