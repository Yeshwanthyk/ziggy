import { getPropertyName, isIdentifier } from "../utils.mjs";

const message =
  "Yield tagged errors directly in Effect.gen instead of yielding Effect.fail(new ErrorType(...)). Skill: effect-typed-errors.";
