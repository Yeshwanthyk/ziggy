...
const stringMessage =
  "Do not stringify unknown errors. Keep typed failures in Effect or normalize at a typed boundary. Skill: effect-typed-errors.";
const messagePropertyMessage =
  "Do not read .message from unknown errors. Preserve typed failures with Effect tagged-error handling. Skill: effect-typed-errors.";
const destructuredMessage =
  "Do not destructure .message from unknown errors. Preserve typed failures with Effect tagged-error handling. Skill: effect-typed-errors.";
