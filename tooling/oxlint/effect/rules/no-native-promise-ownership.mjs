...
const message =
  "Migrated domain code must not own native Promise control flow. Keep pure synchronous TypeScript synchronous; model asynchronous work with Effect and isolate forced Promise APIs in an approved adapter. Skill: effect-runtime-boundaries.";
