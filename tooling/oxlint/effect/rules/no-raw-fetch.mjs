...
const message =
  "Do not call raw fetch in Ziggy domain code. Route HTTP through Effect HttpClient or an explicit adapter boundary. Skill: wrdn-effect-raw-fetch-boundary.";

const checkedPrefixes = ["packages/"];
