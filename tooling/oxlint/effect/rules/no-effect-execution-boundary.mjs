...
const message =
  "Do not execute Effect inside domain code. Return an Effect and run it only at an approved executable or test adapter boundary. Skill: wrdn-effect-runtime-boundaries.";
