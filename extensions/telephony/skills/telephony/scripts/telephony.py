#!/usr/bin/env python3
"""Telephony helper for the Ziggy/Pi telephony skill.

Capabilities:
- Persist telephony provider credentials to a skill-specific configuration directory
...
def _env_path() -> Path:
    return _telephony_home() / ".env"


def _state_path() -> Path:
    return _telephony_home() / "telephony_state.json"
...
def _env_or_config(env_key: str, *_unused_paths: tuple[str, ...], default: str = "") -> str:
