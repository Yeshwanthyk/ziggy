...
Also apply this skill to **your own** output when writing user-facing prose — release notes, PR descriptions, documentation, long-form explanations, and summaries.

## How to use it

The text usually arrives one of three ways:
1. **Inline** — user pastes the text directly into the message. Work on it in-place, reply with the rewrite.
2. **File** — user points at a file. Read it with the available file tools, then apply focused edits. For Markdown documents, a targeted edit per section is cleaner than rewriting the whole file.
...
10. If the text came from a file, apply the edit and show the user what changed.
...
Original author: Siqi Chen ([@blader](https://github.com/blader)). Upstream project: https://github.com/blader/humanizer (version 2.5.1). The original MIT license is preserved in [LICENSE](LICENSE) alongside this `SKILL.md`.
