import { macosBackend } from "./macos/backend.mts";
import { isBrowserApp, isChromeFamilyApp, openBrowserLocationWithAppleScript } from "./macos/browser.mts";
import { ensureMacosReady } from "./macos/permissions.mts";
import type { ComputerUsePlatformBackend, PlatformName } from "./types.mts";
import { linuxBackend } from "./linux/backend.mts";
import { windowsBackend } from "./windows/backend.mts";
