import { runProcess } from "./helper.mjs";
...
export function isBrowserApp(appName, bundleId) {
    return BROWSER_BUNDLE_IDS.has(bundleId ?? "") || BROWSER_APP_NAMES.has(normalizeText(appName));
}
export function isChromeFamilyApp(appName, bundleId) {
...
export async function openBrowserLocationWithAppleScript(target, url, signal) {
