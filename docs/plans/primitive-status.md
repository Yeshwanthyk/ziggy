...
Current Ziggy status on 2026-07-31.
...
| Automation | [Profile-owned Markdown definitions and bounded Markdown receipts](../automations.md); unified Run now/scheduled admission; cron/at/every; foreground scheduler; launchd and systemd-user services; scheduler/next/latest/run-history TUI projections; local-first Telegram, Discord, and Slack outcomes. | Shipped. Keep retries, replay, Windows services, webhooks, and unbounded history out. |
